...
class categoria extends CI_Controller {
  ...
  public function __construct()
  {
    ...
    $this->links = array(
      'novo' => 'elda/cadastro/categoria/novo/',
      'atualizar' => '',
      'voltar' => 'elda/cadastro/categoria/',
	...
	{
    $this->links['atualizar'] = 'elda/cadastro/categoria/';
    $this->links['voltar'] = '';
    $data = array(
      'links' => $this->links,
      'grid' => $this->Categoria_mod->get_categorias(),
    );
		$this->load->view('elda/cadastro/categoria/grid',$data);
	}
  ...
  public function novo()
  {
    $mensagem = null;
    $this->links['novo'] = '';
    $this->links['atualizar'] = 'elda/cadastro/categoria/novo/';
    $data = array(
      'links' => $this->links,
      'editar' => false,
      'url_form' => 'elda/cadastro/categoria/novo/',
      'form' => null,
    );
    ...
    if (!empty($form)) {
      ...
      if ($this->form_validation->run() == TRUE){
        ...
        if(!$res){
          ...
          redirect(base_url().'elda/cadastro/categoria/editar/'.$res,'location');
        }
      }
      else
    ...
    $this->load->view('elda/cadastro/categoria/form',$data);
  }

  public function editar($id_categoria)
  {
    $mensagem = null;
    $this->links['atualizar'] = 'elda/cadastro/categoria/editar/'.$id_categoria;
    $data = array(
      'links' => $this->links,
      'editar' => true,
      'url_form' => 'elda/cadastro/categoria/editar/'.$id_categoria,
    );
    $form = $this->input->post();
    if (!empty($form)) {
      $form = (object) $form;
