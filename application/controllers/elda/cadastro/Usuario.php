...
class usuario extends CI_Controller {
  ...
  public function __construct()
  {
    ...
    $this->links = array(
      'novo' => 'elda/cadastro/usuario/novo/',
      'atualizar' => '',
      'voltar' => 'elda/cadastro/usuario/',
	...
	{
    $this->links['atualizar'] = 'elda/cadastro/usuario/';
    $this->links['voltar'] = '';
    $data = array(
      'links' => $this->links,
      'grid' => $this->usuario_mod->get_usuarios(),
    );
		$this->load->view('elda/cadastro/usuario/grid',$data);
	}
  ...
  public function novo()
  {
    $mensagem = null;
    $this->links['novo'] = '';
    $this->links['atualizar'] = 'elda/cadastro/usuario/novo/';
    $data = array(
      'links' => $this->links,
      'editar' => false,
      'url_form' => 'elda/cadastro/usuario/novo/',
      'form' => null,
    );
    ...
    if (!empty($form)) {
      ...
      if ($this->form_validation->run() == TRUE){
        ...
        if(!$res){
          ...
          redirect(base_url().'elda/cadastro/usuario/editar/'.$res,'location');
        }
      }
      else
    ...
    $this->load->view('elda/cadastro/usuario/form',$data);
  }

  public function editar($id_usuario)
  {
    $mensagem = null;
    $this->links['atualizar'] = 'elda/cadastro/usuario/editar/'.$id_usuario;
    $data = array(
      'links' => $this->links,
      'editar' => true,
      'url_form' => 'elda/cadastro/usuario/editar/'.$id_usuario,
    );
    $form = $this->input->post();
    if (!empty($form)) {
      $form = (object) $form;
