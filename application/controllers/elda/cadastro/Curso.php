...
class curso extends CI_Controller {
  ...
  public function __construct()
  {
    ...
    $this->links = array(
      'novo' => 'elda/cadastro/curso/novo/',
      'atualizar' => '',
      'voltar' => 'elda/cadastro/curso/',
      'fechar' => 'elda/menu/cadastro/'
    );
  }

	public function index()
	{
    $this->links['atualizar'] = 'elda/cadastro/curso/';
    $this->links['voltar'] = '';
    $data = array(
      'links' => $this->links,
      'grid' => $this->curso_mod->get_cursos(),
    );
		$this->load->view('elda/cadastro/curso/grid',$data);
	}
  ...
  public function novo()
  {
    ...
    $mensagem = null;
    $this->links['novo'] = '';
    $this->links['atualizar'] = 'elda/cadastro/curso/novo/';
    $data = array(
      'links' => $this->links,
      'editar' => false,
      'url_form' => 'elda/cadastro/curso/novo/',
      'form' => null,
    ...
    if (!empty($form)) {
      ...
      if ($this->form_validation->run() == TRUE){
        ...
        if(!$res){
          ...
          redirect(base_url().'elda/cadastro/curso/estrutura_curso/'.$res,'location');
        }
      }
      else
    ...
    $this->load->view('elda/cadastro/curso/form',$data);
  }

  public function editar($id_curso)
  {
    $mensagem = null;
    $this->links['atualizar'] = 'elda/cadastro/curso/editar/'.$id_curso;
    $this->links['voltar'] = 'elda/cadastro/curso/estrutura_curso/'.$id_curso;
    $this->links['novo'] = '';
    $this->load->model('elda/categoria_mod');
    $data = array(
      'links' => $this->links,
      'editar' => true,
      'url_form' => 'elda/cadastro/curso/editar/'.$id_curso,
      'categorias' => $this->categoria_mod->get_categorias_ativas(),
    );
    $form = $this->input->post();
    if (!empty($form)) {
  ...
  {
    $mensagem = null;
    $this->links['atualizar'] = 'elda/cadastro/curso/estrutura_curso/'.$id_curso;
    $this->links['novo'] = '';
    $data = array(
      'links' => $this->links,
      'editar' => true,
      'url_form' => 'elda/cadastro/curso/estrutura_curso/'.$id_curso,
    );
    ...
    $this->load->view('mensagens',$mensagem);
    $this->load->view('elda/cadastro/curso/form-estrutura',$data);
  }
  ...
  public function novo_unidade($id_curso)
  {
    $mensagem = null;
    $this->links['novo'] = '';
    $this->links['atualizar'] = 'elda/cadastro/curso/novo_unidade/'.$id_curso;
    $this->links['voltar'] = 'elda/cadastro/curso/estrutura_curso/'.$id_curso;
    $data = array(
      'links' => $this->links,
      'editar' => false,
      'url_form' => 'elda/cadastro/curso/novo_unidade/'.$id_curso,
      'form' => null,
    ...
    if (!empty($form)) {
      ...
      if ($this->form_validation->run() == TRUE){
        ...
        if(!$res){
          ...
          $mensagem = array('texto' => 'Sucesso!', 'tipo'  => 'SweetAlert', 'class' => 'success');
          $this->session->set_flashdata('sucesso_cadastro', true);
          redirect(base_url().'elda/cadastro/curso/editar_unidade/'.$id_curso.'/'.$res,'location');
        }
      }
      else
        $mensagem = array('texto' => validation_errors(), 'tipo'  => 'SweetAlert', 'class' => 'warning');
    ...
    $this->load->view('mensagens',$mensagem);
    $this->load->view('elda/cadastro/curso/form-unidade',$data);
  }
  ...
  public function editar_unidade($id_curso,$id_unidade)
  {
    $mensagem = null;
    $this->links['novo'] = '';
    $this->links['atualizar'] = 'elda/cadastro/curso/editar_unidade/'.$id_curso.'/'.$id_unidade;
    $this->links['voltar'] = 'elda/cadastro/curso/estrutura_curso/'.$id_curso;
    $data = array(
      'links' => $this->links,
      'editar' => true,
      'url_form' => 'elda/cadastro/curso/editar_unidade/'.$id_curso.'/'.$id_unidade,
      'form' => null,
      'curso' => $this->curso_mod->get_curso($id_curso),
  ...
  public function novo_video($id_curso,$id_unidade)
  {
    ...
    $mensagem = null;
    $this->links['novo'] = '';
    $this->links['atualizar'] = 'elda/cadastro/curso/novo_video/'.$id_curso.'/'.$id_unidade;
    $this->links['voltar'] = 'elda/cadastro/curso/editar_unidade/'.$id_curso.'/'.$id_unidade;
    $data = array(
      'links' => $this->links,
      'editar' => false,
      'url_form' => 'elda/cadastro/curso/novo_video/'.$id_curso.'/'.$id_unidade,
      'form' => null,
      'curso' => $this->curso_mod->get_curso($id_curso),
    ...
    if (!empty($form)) {
      ...
      if ($this->form_validation->run() == TRUE){
        ...
        if(isset($_FILES['video']) && $_FILES['video']['name'][0] != null){
          ...
          if (!$erro_upload) {
            $res = $this->curso_mod->novo_video($id_unidade,$form,$upload);
            if(!$res){
              $mensagem = array('texto' => 'Erro ao cadastrar! Tente novamente!', 'tipo'  => 'SweetAlert', 'class' => 'error');
            }
            else{
              $mensagem = array('texto' => 'Sucesso!', 'tipo'  => 'SweetAlert', 'class' => 'success');
              $this->session->set_flashdata('sucesso_cadastro', true);
              redirect(base_url().'elda/cadastro/curso/editar_video/'.$id_curso.'/'.$id_unidade.'/'.$res,'location');
            }
          }
          else {
    ...
    $this->load->view('mensagens',$mensagem);
    $this->load->view('elda/cadastro/curso/form-video',$data);
  }
  ...
  public function editar_video($id_curso,$id_unidade,$id_video)
  {
    ...
    $mensagem = null;
    $this->links['novo'] = '';
    $this->links['atualizar'] = 'elda/cadastro/curso/editar_video/'.$id_curso.'/'.$id_unidade.'/'.$id_video;
    $this->links['voltar'] = 'elda/cadastro/curso/editar_unidade/'.$id_curso.'/'.$id_unidade;
    $data = array(
      'links' => $this->links,
      'editar' => true,
      'url_form' => 'elda/cadastro/curso/editar_video/'.$id_curso.'/'.$id_unidade.'/'.$id_video,
      'form' => null,
      'curso' => $this->curso_mod->get_curso($id_curso),
  ...
  public function novo_material($id_curso,$id_unidade)
  {
    ...
    $mensagem = null;
    $this->links['novo'] = '';
    $this->links['atualizar'] = 'elda/cadastro/curso/novo_material/'.$id_curso.'/'.$id_unidade;
    $this->links['voltar'] = 'elda/cadastro/curso/editar_unidade/'.$id_curso.'/'.$id_unidade;
    $data = array(
      'links' => $this->links,
      'editar' => false,
      'url_form' => 'elda/cadastro/curso/novo_material/'.$id_curso.'/'.$id_unidade,
      'form' => null,
      'curso' => $this->curso_mod->get_curso($id_curso),
      'unidade' => $this->curso_mod->get_unidade($id_unidade),
    );
        ...
        if(isset($_FILES['arquivo']) && $_FILES['arquivo']['name'][0] != null){
          ...
          if (!$erro_upload) {
            ...
            if(!$res){
              ...
              $mensagem = array('texto' => 'Sucesso!', 'tipo'  => 'SweetAlert', 'class' => 'success');
              $this->session->set_flashdata('sucesso_cadastro', true);
              redirect(base_url().'elda/cadastro/curso/editar_material/'.$id_curso.'/'.$id_unidade.'/'.$res,'location');
            }
          }
          else {
  ...
  public function editar_material($id_curso,$id_unidade,$id_material)
  {
    ...
    $mensagem = null;
    $this->links['novo'] = '';
    $this->links['atualizar'] = 'elda/cadastro/curso/editar_material/'.$id_curso.'/'.$id_unidade.'/'.$id_material;
    $this->links['voltar'] = 'elda/cadastro/curso/editar_unidade/'.$id_curso.'/'.$id_unidade;
    $data = array(
      'links' => $this->links,
      'editar' => true,
      'url_form' => 'elda/cadastro/curso/editar_material/'.$id_curso.'/'.$id_unidade.'/'.$id_material,
      'form' => null,
      'curso' => $this->curso_mod->get_curso($id_curso),
      'diretorio' => $diretorio_pagina,
      'unidade' => $this->curso_mod->get_unidade($id_unidade),
