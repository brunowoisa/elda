<script> 
  ...
  var crumbs = [
    ...
    { nome: "Cadastro de Usuários", href: "elda/administrativo/usuario/" },
  ...
  <?php if ($editar): ?>
    function enviar_senha_email() {
      ...
      $.ajax({
        url: '<?php echo base_url(); ?>elda/administrativo/usuario/ajax_enviar_senha_email/',
        type: 'POST',
        dataType: 'json',
      ...
      <div class="row">
        <div class="col-sm-3">
          <div class="form-group <?php echo form_status('cpf'); ?>">  
            ...
            <input type="text" class="form-control m-input m-input--square" name="cpf" data-inputmask="'mask': '999.999.999-99'" value="<?php echo set_form_value($editar,$form,'cpf'); ?>" autocomplete="off">
          </div>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-sm-3">
          <div class="form-group <?php echo form_status('administrador'); ?>">  
            ...
            <select class="form-control m-select2 m-input--square" name="administrador">
              ...
              <option value="0" <?php echo set_form_select($editar,$form,'administrador', '0'); ?>>Funcionário</option>
            </select>
          </div>
        </div>
        <div class="col-sm-9">
