...
<div class="m-portlet m-portlet--bordered m-portlet--unair">
  <div class="m-portlet__body">
    ...
    <div class="row">
      <div class="col-sm-6">
        <a  style="margin-top: -80px;" href="<?php echo base_url(); ?>elda/administrativo/curso/editar/<?php echo $curso->id; ?>" class="btn m-btn--square  btn-outline-primary m-btn m-btn--custom"><i class="fa fa-edit"></i> Editar Curso</a>
      </div>
    </div>
    ...
    <div class="row" style="margin-bottom: 20px;">
      <div class="col-sm-12">
        <b>Descrição:</b> <?php echo line2br($curso->descricao); ?>
      </div>
    </div>
        ...
        <div class="m-portlet m-portlet--primary m-portlet--head-solid-bg m-portlet--bordered">
          <div class="m-portlet__head">
            ...
            <div class="m-portlet__head-tools">
              <a href="<?php echo base_url(); ?>elda/administrativo/curso/editar_unidade/<?php echo $curso->id; ?>/<?php echo $unidade->id; ?>" class="m-btn btn btn-outline-light"><i class="la la-edit"></i> Editar</a>
            </div>
          </div>
          <div class="m-portlet__body">
                ...
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <?php foreach ($unidade->videos as $video): ?>
                      <?php if ($video->ativo): ?>
                        <a href="<?php echo base_url(); ?>elda/administrativo/curso/editar_video/<?php echo $curso->id; ?>/<?php echo $unidade->id; ?>/<?php echo $video->id; ?>/" class="m-list-search__result-item">
                  ...
                  <div class="col-sm-6">
                    ...
                    <?php foreach ($unidade->materiais as $material): ?>
                      ...
                      <?php if ($material->ativo): ?>
                        <a href="<?php echo base_url(); ?>elda/administrativo/curso/editar_material/<?php echo $curso->id; ?>/<?php echo $unidade->id; ?>/<?php echo $material->id; ?>/" class="m-list-search__result-item">
    ...
    <div class="row" style="margin-bottom: 20px; margin-top: 20px;">
      <div class="col-sm-12" style="text-align: center;">
        <a href="<?php echo base_url(); ?>elda/administrativo/curso/novo_unidade/<?php echo $curso->id; ?>" class="btn m-btn--square  btn-primary m-btn m-btn--custom"><i class="la la-plus"></i> Nova Unidade</a>
      </div>
    </div>
