<script> 
  ...
  var crumbs = [
    ...
    <?php if ($editar): ?>
      { nome: "Estruturação do Curso", href: "elda/administrativo/curso/estrutura_curso/<?php echo $form->id; ?>" },
    <?php endif ?>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="form-group <?php echo form_status('descricao'); ?>">  
            ...
            <textarea class="form-control m-input" name="descricao" rows="10"><?php echo set_form_value($editar,$form,'descricao'); ?></textarea>
          </div>
        </div>
      </div>
      <div class="row">
