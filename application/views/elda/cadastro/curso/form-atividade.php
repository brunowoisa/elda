                ...
                <div class="m-portlet__body">
                  <div class="row">
                    <div class="col-sm-12">
                      ...
                      <input type="text" class="form-control m-input m-input--square" name="questao[<?php echo $key+1; ?>][alternativa][c]" value="<?php echo $questao->alternativa_correta; ?>">
                      <h5 class="m--font-danger">Alternativa Errada 1</h5>
                      <input type="text" class="form-control m-input m-input--square" name="questao[<?php echo $key+1; ?>][alternativa][e1]" value="<?php echo $questao->alternativa_errada_1; ?>">
                      <h5 class="m--font-danger">Alternativa Errada 2</h5>
                      <input type="text" class="form-control m-input m-input--square" name="questao[<?php echo $key+1; ?>][alternativa][e2]" value="<?php echo $questao->alternativa_errada_2; ?>">
                      <h5 class="m--font-danger">Alternativa Errada 3</h5>
                      <input type="text" class="form-control m-input m-input--square" name="questao[<?php echo $key+1; ?>][alternativa][e3]" value="<?php echo $questao->alternativa_errada_3; ?>">
                      <h5 class="m--font-danger">Alternativa Errada 4</h5>
                      <input type="text" class="form-control m-input m-input--square" name="questao[<?php echo $key+1; ?>][alternativa][e4]" value="<?php echo $questao->alternativa_errada_4; ?>">
                    </div>
                  </div>
                </div>
              </div>
                ...
                '<div class="m-portlet__body">'+
                  '<div class="row">'+
                    '<div class="col-sm-12">'+
                      ...
                      '<h5 class="m--font-success">Alternativa Correta</h5>'+
                      '<input type="text" class="form-control m-input m-input--square" name="questao['+numero_questao+'][alternativa][c]"></textarea>'+
                      '<h5 class="m--font-danger">Alternativa Errada 1</h5>'+
                      '<input type="text" class="form-control m-input m-input--square" name="questao['+numero_questao+'][alternativa][e1]"></textarea>'+
                      '<h5 class="m--font-danger">Alternativa Errada 2</h5>'+
                      '<input type="text" class="form-control m-input m-input--square" name="questao['+numero_questao+'][alternativa][e2]"></textarea>'+
                      '<h5 class="m--font-danger">Alternativa Errada 3</h5>'+
                      '<input type="text" class="form-control m-input m-input--square" name="questao['+numero_questao+'][alternativa][e3]"></textarea>'+
                      '<h5 class="m--font-danger">Alternativa Errada 4</h5>'+
                      '<input type="text" class="form-control m-input m-input--square" name="questao['+numero_questao+'][alternativa][e4]"></textarea>'+
                    '</div>'+
                  '</div>'+
                '</div>'+
              '</div>';
